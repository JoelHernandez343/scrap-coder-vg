...
namespace ScrapCoder.Interpreter {
    public class DecreaseToVariableInterpreter : MonoBehaviour, IInterpreterElement {
        ...
        public void Execute(string answer) {
            ...
            Debug.Log($"Decreasing to number variable: {variable.symbolName} with value {SymbolTable.instance[variable.symbolName].value}");
